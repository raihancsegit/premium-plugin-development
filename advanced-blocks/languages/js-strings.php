...
$generated_i18n_strings = array(
	/* translators: Copyright (C) 2018 advanced Blocks
	This file is distributed under the same license as the advanced Blocks package. */
	// Reference: languages/js-strings.php:8
	__( 'Toggle block', 'advanced' ),
	...
	__( 'Please set an API key to use this block under <a href="%s">advanced Blocks</a> > Settings > Website Card.', 'advanced' ),

	// Reference: languages/js-strings.php:272
	__( 'Website Card', 'advanced' ),

	// Reference: languages/js-strings.php:275
	__( 'Paste URL or type', 'advanced' ),

	// Reference: languages/js-strings.php:278
	__( 'Link to', 'advanced' ),

	// Reference: languages/js-strings.php:281
	__( 'Website Card Settings', 'advanced' ),

	// Reference: languages/js-strings.php:284
	__( 'A nice description for website-card block.', 'advanced' ),
	...
	__( 'Bottom Left', 'advanced' ),

	// Reference: languages/js-strings.php:314
	__( 'Bottom', 'advanced' ),

	// Reference: languages/js-strings.php:317
	__( 'Bottom Right', 'advanced' ),

	// Reference: languages/js-strings.php:320
	__( 'Icon Size', 'advanced' ),

	// Reference: languages/js-strings.php:323
	__( 'Select Icon', 'advanced' ),

	// Reference: languages/js-strings.php:326
	__( 'Type icon name...', 'advanced' ),

	// Reference: languages/js-strings.php:329 settings/class-advanced-blocks-api.php:65
	__( 'No blocks found, please initiate the Gutenberg editor by visiting the post edit screen.', 'advanced' ),

	// Reference: languages/js-strings.php:332 settings/class-advanced-blocks-api.php:79
	// Reference: settings/class-advanced-blocks-api.php:93
	__( 'Incorrect content type. Provided data must have "application/json" type.', 'advanced' )
);
